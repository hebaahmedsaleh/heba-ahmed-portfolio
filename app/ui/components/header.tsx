...
import Logo from "../../ui/light-logo.svg";
...
function Header() {
  ...
  return (
    <header>
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-1.5 dark:bg-gray-800 shadow">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-lg">
          <a href="#" className="flex items-center">
            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white ">
              <Image src={Logo} alt="my-logo" className="logo-container" />
            </span>
          </a>
          ...
          >
            <ul className="flex flex-col md:flex-row md:gap-8 gap-0">
              <Tab title="About Me" link="aboutMe" />
              <Tab title="Skills" link="skills" />
              <Tab title="Previous Work Projects" link="work-projects" />
              <Tab title="Projects" link="projects" />

              <Tab title="Experience" link="experience" />
